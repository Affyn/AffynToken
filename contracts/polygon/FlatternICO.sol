    ...
    Ownable
{
    ...
    */
    function buyTokensWithValueAndReferee(address beneficiary, uint boughtAmount, address referee) public nonReentrant payable {
        ...
        // update state
        super.updateWeiRaised(weiAmount);
    ...
    */
    ...
    function buyTokensWithValueEth(address beneficiary, uint boughtAmount) public nonReentrant payable {
        uint256 amount = boughtAmount * 10 ** uint256(_token.decimals());
        uint256 weiAmount = amount;
        _preValidatePurchase(beneficiary, weiAmount);
    ...
    function approveFunds() public {
        _approveFunds(_individualDefaultCap);
    }
